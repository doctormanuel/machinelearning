...
We observe that the highest accuracy (98.92%) is obtained for the random forest model without removing highly inter-correlated variables. We now use that model to predict the *classe* variable fo the prediction data.
```{r}
